...
export default function ShareButtons({ title }: { title: string }) {
  ...
  const shareLinks = {
    ...
    zalo: `https://zalo.me/share?link=${encodeURIComponent(url)}`,
  ...
  return (
    <div className="mt-10 pt-8 border-t border-gray-100">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
          Email
        </a>
