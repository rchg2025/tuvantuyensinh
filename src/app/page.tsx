              ...
              <div key={q.id} className="bg-white rounded-2xl border border-blue-100 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-200 overflow-hidden">
                ...
                <div className="p-5 flex items-start gap-4">
                  {q.isFromSchool && adminAvatars[q.askerName] ? (
                    <img src={adminAvatars[q.askerName]!} alt={q.askerName} width={40} height={40} className="flex-shrink-0 w-10 h-10 rounded-full object-cover bg-blue-100" loading="lazy" decoding="async" />
                  ) : (
                ...
                {q.answer ? (
                  <div className="bg-blue-50 border-t border-blue-100 px-5 py-4 flex items-start gap-4">
                    {adminAvatars[q.answeredBy || ""] ? (
                      <img src={adminAvatars[q.answeredBy || ""]!} alt={q.answeredBy || "Chuyên viên tư vấn"} width={40} height={40} className="flex-shrink-0 w-10 h-10 rounded-full object-cover bg-blue-600" loading="lazy" decoding="async" />
                    ) : (
