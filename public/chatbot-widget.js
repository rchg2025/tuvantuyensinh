...
(function() {
    ...
    <div class="ai-chatbot-container">
      ...
      <div class="ai-chatbot-messages">
        <div class="ai-msg bot" style="background:#eff6ff; border-color:#dbeafe; color:#1e3a8a;">
          <b><span>??</span> Xin chào!</b><br/>Tôi là chatbot tu v?n tuy?n sinh và gi?i thi?u v? <b>${title}</b>.<br/>B?n hãy d?t câu h?i d? du?c tu v?n nhé!
        </div>
      </div>
      <form class="ai-chatbot-form">
        <input type="text" class="ai-chatbot-input" placeholder="Nh?p câu h?i c?a b?n..." autocomplete="off" />
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      typingMsg.remove();
      addMsg("Xin l?i, hi?n t?i dang có l?i k?t n?i. Vui lòng th? l?i sau.", false);
    } finally {
      isLoading = false;
